const Banner = () => {
  return (
    <div className="w-full relative max-w-6xl mx-auto p-3">
      <p className="w-full relative text-sm md:text-3xl text-center bg-red-600 text-white px-4 py-5 overflow-hidden rounded-lg">
